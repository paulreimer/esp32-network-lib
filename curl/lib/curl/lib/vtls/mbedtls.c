...
static CURLcode mbedtls_version_from_curl(int *mbedver, long version)
{
  ...
  switch(version) {
    ...
    case CURL_SSLVERSION_TLSv1_2:
      *mbedver = 3 /* MBEDTLS_SSL_MINOR_VERSION_3 */;
      return CURLE_OK;
...
#if MBEDTLS_VERSION_NUMBER >= 0x03000000
  int mbedtls_ver_min = 3 /* MBEDTLS_SSL_MINOR_VERSION_3 */;
  int mbedtls_ver_max = 3 /* MBEDTLS_SSL_MINOR_VERSION_3 */;
#else
...
#if MBEDTLS_VERSION_NUMBER >= 0x03000000
  mbedtls_ssl_conf_min_tls_version(&backend->config, MBEDTLS_SSL_VERSION_TLS1_2);
  mbedtls_ssl_conf_max_tls_version(&backend->config, MBEDTLS_SSL_VERSION_TLS1_2);
#else
